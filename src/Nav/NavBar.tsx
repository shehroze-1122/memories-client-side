            ...
            <Toolbar >
              ...
              {user?(
                <div style={{ display:'flex', marginLeft:'auto'}}>
                    <Avatar sx={{ bgcolor: blue[500] }} aria-label="recipe" alt={user.name}>{user.name[0]}</Avatar>
                    <Typography component='h6' color='#0cc' sx={{ display: { xs: 'none', sm: 'block' } }} style={{alignSelf:'center', paddingLeft:'8px'}}>{user.name}</Typography>
